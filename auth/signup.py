...
def signup_page():
    ...
    with col_center:
        ...
        with st.container(border=True):
            ...
            re_password = st.text_input("Re-enter Password", type="password", key="reg_re_password", placeholder="Confirm password")
            ...
            if st.button("Create Account", use_container_width=True, type="primary"):
                ...
                if not u or not e or not p or not rp:
                    ...
                    if success:
                        st.session_state["reg_success_msg"] = "Account created successfully! Please log in."
